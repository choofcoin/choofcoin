...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CHOOF");
    case mBTC: return QString("mCHOOF");
    case uBTC: return QString::fromUtf8("μCHOOF");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ChoofCoins"));
    case mBTC: return QString(QObject::tr("Milli-ChoofCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ChoofCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
