...
const string strMessageMagic = "ChoofCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("choofcoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ChoofCoin
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ChoofCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Get BAKED";
        CTransaction txNew;
        txNew.nTime = 1476396280;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print        
        block.print();
        assert(block.hashMerkleRoot == uint256("0xeff7cdc1498e72b1284e9978ba0ccaafdfe6ed35bec48cb76d355a289ffc7df5"));
...
unsigned char pchMessageStart[4] = { 0xa4, 0xa6, 0xfd, 0x05 };
